...
contract CarLoan is IERC721Token, SafeMath {
  ...
  function _mint(address _to, uint256 _tokenId, string memory _infoUrl) internal {
      require(
          _to != address(0),
          "ERC721_ZERO_TO_ADDRESS"
      );
      ...
      token.mintedAt = uint64(now);
      token.infoUrl = _infoUrl;
